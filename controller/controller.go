...
import (
	"context"
	"fmt"
	controllerv1 "github.com/Rudro-25/sample-controller/pkg/apis/rudro.dev/v1alpha1"
	clientset "github.com/Rudro-25/sample-controller/pkg/generated/clientset/versioned"
	informer "github.com/Rudro-25/sample-controller/pkg/generated/informers/externalversions/rudro.dev/v1alpha1"
	lister "github.com/Rudro-25/sample-controller/pkg/generated/listers/rudro.dev/v1alpha1"
...
func NewController(
	...
	klusterInformer.Informer().AddEventHandler(cache.ResourceEventHandlerDetailedFuncs{
...
func (c *Controller) ProcessNextItem() bool {
	...
	err := func(obj interface{}) error {
		...
		c.workQueue.Forget(obj)
		log.Println("Successfully synced '%s'\n", key)
		return nil
	}(obj)
...
func (c *Controller) syncHandler(key string) error {
	...
	if errors.IsNotFound(err) {
		deployment, err = c.kubeclientset.AppsV1().Deployments(kluster.Namespace).Create(context.TODO(), newDeployment(kluster), metav1.CreateOptions{})
	}
...
func newDeployment(kluster *controllerv1.Kluster) *appsv1.Deployment {
...
func newService(kluster *controllerv1.Kluster) *corev1.Service {
	labels := map[string]string{
		"app": "my-app",
	}
	return &corev1.Service{
		...
		ObjectMeta: metav1.ObjectMeta{
			Name: kluster.Spec.Name + "-service",
