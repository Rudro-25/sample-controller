...
import (
	...
	scheme "github.com/Rudro-25/sample-controller/pkg/generated/clientset/versioned/scheme"
...
func (c *klusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Kluster, err error) {
...
func (c *klusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KlusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KlusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("klusters").
...
func (c *klusters) Create(ctx context.Context, kluster *v1alpha1.Kluster, opts v1.CreateOptions) (result *v1alpha1.Kluster, err error) {
	result = &v1alpha1.Kluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("klusters").
...
func (c *klusters) Update(ctx context.Context, kluster *v1alpha1.Kluster, opts v1.UpdateOptions) (result *v1alpha1.Kluster, err error) {
	result = &v1alpha1.Kluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("klusters").
...
func (c *klusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Kluster, err error) {
	result = &v1alpha1.Kluster{}
