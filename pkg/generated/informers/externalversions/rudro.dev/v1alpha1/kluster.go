...
import (
	...
	rudrodevv1alpha1 "github.com/Rudro-25/sample-controller/pkg/apis/rudro.dev/v1alpha1"
	versioned "github.com/Rudro-25/sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Rudro-25/sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Rudro-25/sample-controller/pkg/generated/listers/rudro.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KlusterV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KlusterV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&rudrodevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rudrodevv1alpha1.Kluster{}, f.defaultInformer)
}
